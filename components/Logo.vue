<template>
  <svg class="logo animate synched" viewBox="0 0 439.43 531.84">
    <title>logo</title>
      <path class="shape-top" d="M 40.72 72.95 l 179.03 126.6 179.88-127.1 L 219.74.54 40.72 72.95 z"></path>
      <path class="shape-left" d="M 1.22 108.95 l 189.5 135.59-.31 284.96 L 1.22 108.95"></path>
      <path class="shape-right" d="M 248.78 244.58 l 189.44-135.63-189.44 420.57 V 244.58 z"></path>
  </svg>
</template>
<style scoped>
  .logo {
