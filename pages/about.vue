    ...
    return {
      ...
      experience: [
        ...
        },
        {
          id: 2,
          company: 'Cognix Systems',
          role: 'Front-end Developer (work-study contract)',
          dates: '10/2015 to 07/2016',
          order: 30,
          description:
        ...
        {
          id: 3,
          company: 'Ireland Website Design',
          role: 'Web Integrator (internship)',
          dates: '04/2014 to 06/2014',
          order: 40,
          description:
      ...
      skills: [
        ...
        { id: 2, skill_name: 'CSS', order: 2 },
        { id: 3, skill_name: 'Sass', order: 3 },
        { id: 4, skill_name: 'Javascript', order: 4 },
        { id: 5, skill_name: 'Angular 2+', order: 5 },
        { id: 6, skill_name: 'VueJS', order: 6 },
        { id: 7, skill_name: 'Asking questions', order: 7 },
        { id: 8, skill_name: 'Ionic', order: 8 },
        { id: 9, skill_name: 'Typescript', order: 9 },
        { id: 10, skill_name: 'Git', order: 10 },
